...
\usepackage{estiloufsm}

\addbibresource{referencias/referencias8.bib}
...
\keyword{Xxxxx}
\keyword{xxxxxxxx}
\keyword{xxxxxx xxxxxx}
\keyword{xxxxxxxxx}
\keyword{xxxxxxx xxxxx}
\keyword{xxxxxxxx xxxxxxxx}

\keywordeng{Xxxxx} 
\keywordeng{xxxxxx}
\keywordeng{xxxxx}
\keywordeng{xxxxxxx xxxxxxx}
\keywordeng{xxxxxxxxxxxxx}
\keywordeng{xxxxxxxxxx xxxxxxx}
\keywordeng{xxxxxxxxx xxxxxxxxx}
...
%=================== Referências ===================
\defbibheading{bibliography}{\chapter*{REFERÊNCIAS}\addcontentsline{toc}{chapter}{REFERÊNCIAS}}
